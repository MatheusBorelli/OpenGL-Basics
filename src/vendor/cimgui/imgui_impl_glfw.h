...
IMGUI_IMPL_API bool     ImGui_ImplGlfw_InitForVulkan(struct GLFWwindow* window, bool install_callbacks);
IMGUI_IMPL_API bool     ImGui_ImplGlfw_InitForOther(struct GLFWwindow* window, bool install_callbacks);
...
IMGUI_IMPL_API void     ImGui_ImplGlfw_WindowFocusCallback(struct GLFWwindow* window, int focused);
IMGUI_IMPL_API void     ImGui_ImplGlfw_CursorEnterCallback(struct GLFWwindow* window, int entered);
...
IMGUI_IMPL_API void     ImGui_ImplGlfw_MonitorCallback(struct GLFWmonitor* monitor, int event);
